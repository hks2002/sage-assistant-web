...
* @LastEditDate          : 2025-01-17 15:17:26
* @FilePath              : sage-assistant-web/src/pages/SalesPage.vue
...
<template>
  <q-page :style-fn="$pageStore.setPageHeightStyle">
    ...
    <div class="row q-col-gutter-sm q-pa-sm" :style="$pageStore.setDomHeightStyle(56)">
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountByCustomerVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountByPNFamilyVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountTopByCustomerVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountTopByRepresentativeVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
      ...
      <div :class="colClass">
        <EchartCustomerSummaryAmountTopByPNFamilyVue
          orderType="ALL"
          :customerCode="customerCode"
          :site="site"
          :dateFrom="dateFrom"
...
<script setup>
import QTableCustomerOrdersVue from '@/components/customers/QTableCustomerOrders.vue'
import EchartCustomerDODVue from '@/components/echarts/EchartCustomerDOD.vue'
import EchartCustomerOTDVue from '@/components/echarts/EchartCustomerOTD.vue'
import EchartCustomerSummaryAmountVue from '@/components/echarts/EchartCustomerSummaryAmount.vue'
import EchartCustomerSummaryAmountByCustomerVue from '@/components/echarts/EchartCustomerSummaryAmountByCustomer.vue'
import EchartCustomerSummaryAmountByPNFamilyVue from '@/components/echarts/EchartCustomerSummaryAmountByPNFamily.vue'
...
import EchartCustomerSummaryAmountTopByCustomerVue from '@/components/echarts/EchartCustomerSummaryAmountTopByCustomer.vue'
import EchartCustomerSummaryAmountTopByPNFamilyVue from '@/components/echarts/EchartCustomerSummaryAmountTopByPNFamily.vue'
import EchartCustomerSummaryAmountTopByRepresentativeVue from '@/components/echarts/EchartCustomerSummaryAmountTopByRepresentative.vue'
