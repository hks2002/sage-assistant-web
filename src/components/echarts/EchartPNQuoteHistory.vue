...
* @LastEditDate          : 2025-01-24 09:28:59
* @FilePath              : sage-assistant-web/src/components/echarts/EchartPNQuoteHistory.vue
...
function prepareData() {
  ...
  if (len >= 20) {
    dataZoomStartValue = get(data[len - 20], 'quoteDate')
  } else if (len > 0) {
    dataZoomStartValue = get(data[0], 'quoteDate')
  }
...
function setEchart() {
  ...
  eChartOption = {
    ...
    toolbox: defaultToolbox(t('S.QUOTES HISTORY'), data),
