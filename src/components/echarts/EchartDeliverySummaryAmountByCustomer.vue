...
* @LastEditDate          : 2025-01-17 15:10:48
* @FilePath              : sage-assistant-web/src/components/echarts/EchartDeliverySummaryAmountByCustomer.vue
...
function doUpdate() {
  ...
  axiosGet('/Data/DeliverySummaryAmountTopByCustomer', {
    Site: props.site,
