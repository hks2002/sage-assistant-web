...
* @LastEditDate          : 2025-01-24 14:29:30
* @FilePath              : sage-assistant-web/src/components/echarts/EchartFinancialInvoiceSummaryAmount.vue
...
function doUpdate() {
  ...
  axiosGet('/Data/FinancialInvoiceSumAmount', {
    Site: props.site,
...
function setEchart() {
  const preTitle = `${props.site}`
  const shortTitle = `${preTitle} ${t('S.INVOICE_AMOUNT')} [${props.dateType}-${props.payStatus}]`
