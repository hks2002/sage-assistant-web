...
* @LastEditDate          : 2023-08-28 17:31:00
* @FilePath              : sage-assistant-web/src/components/echarts/EchartSalesHistory.vue
...
function setEchart() {
  ...
  eChartOption = {
    ...
    toolbox: defaultToolbox(dimensions, data, t('S.SALES_HISTORY')),
