...
* @LastEditDate          : 2025-01-24 10:02:47
* @FilePath              : sage-assistant-web/src/components/echarts/EchartDeliverySummaryAmount.vue
...
function doUpdate() {
  ...
  axiosGet('/Data/DeliverySummaryAmount', {
    Site: props.site,
...
function setEchart() {
  ...
  const shortTitle = `${preTitle} ${t('S.DELIVERY_AMOUNT')}`
  const longTitle = `${shortTitle} (${props.dateFrom}-->${props.dateTo})`

  // data is ready,set echart option
  eChartOption = {
    title: defaultTitle(shortTitle, t('S.DELIVERY_AMOUNT_DESCRIPTION')),
    ...
    grid: [
      ...
      { left: '80', right: '40', top: '60%', bottom: '20' }
    ],
    xAxis: [
      {
        gridIndex: 0,
