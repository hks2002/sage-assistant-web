...
* @LastEditDate          : 2025-01-17 15:11:12
* @FilePath              : sage-assistant-web/src/components/echarts/EchartDeliverySummaryAmountByPNFamily.vue
...
function doUpdate() {
  ...
  axiosGet('/Data/DeliverySummaryAmountTopByPNFamily', {
    Site: props.site,
