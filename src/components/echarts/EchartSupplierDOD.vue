...
* @LastEditDate          : 2025-01-13 02:19:15
* @FilePath              : sage-assistant-web/src/components/echarts/EchartSupplierDOD.vue
...
function setEchart() {
  ...
  const shortTitle = `${preTitle} ${t('S.PURCHASE_ORDER_DOD')}`
