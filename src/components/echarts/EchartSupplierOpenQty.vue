...
* @CreatedDate           : 2023-06-22 21:34:00
* @LastEditors           : Robert Huang<56649783@qq.com>
* @LastEditDate          : 2023-08-28 00:02:55
* @FilePath              : sage-assistant-web/src/components/echarts/EchartSupplierOpenQty.vue
...
function setEchart() {
  ...
  eChartOption = {
    title: {
      text: t('S.OPEN_QTY_ALL'),
      subtext: '',
      left: 'center'
    },
    legend: defaultLegend,
    toolbox: defaultToolbox(dimensions, data, t('S.OPEN_QTY_ALL')),
